...
class AdManager(private val context: Context) {
    ...
    /**
     * Charge la vidéo avec récompense pour révéler la solution
     */
    ...
    /**
     * Affiche la vidéo avec récompense pour essai supplémentaire
     * @param onRewarded Appelé quand l'utilisateur gagne la récompense
     * @param onAdDismissed Appelé quand la pub est fermée (avec ou sans récompense)
     */
    ...
    /**
     * Affiche la vidéo avec récompense pour révéler la solution
     * @param onRewarded Appelé quand l'utilisateur gagne la récompense
     * @param onAdDismissed Appelé quand la pub est fermée (avec ou sans récompense)
     */
    ...
    /**
     * Vérifie si la vidéo Extra Try est disponible
     */
    ...
    /**
     * Vérifie si la vidéo Solution est disponible
     */
